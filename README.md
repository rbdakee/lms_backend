...
Код входа в разработке никуда не уходит: `SMS_PROVIDER=log` — заглушка,
она пишет код в лог сервиса (`SMS на ***4567: код 1234`). В бою стоит
`whatsapp` — код уходит согласованным шаблоном через Cloud API, см. `DEPLOY.md`.
