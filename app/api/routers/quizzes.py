...
def quiz(
    ...
    return QuizOut(**svc.quiz_page(user, quiz_id, platform))
...
def start_attempt(
    ...
    return QuizAttemptOut(**svc.start(user, quiz_id, platform))
...
def save_answer(
    ...
    svc.answer(user, attempt_id, body.question_id, body.option_ids, platform)
...
def finish_attempt(
    ...
    return QuizResultOut(**svc.finish(user, attempt_id, platform))
...
def attempt_review(
    ...
    return QuizReviewOut(**svc.review(user, attempt_id, platform))
